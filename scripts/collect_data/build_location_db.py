...
to efficiently cover the space while respecting Spotify API rate limits.
...
Dependencies:
    ...
    - spotify (local module): Spotify API wrapper
...
def check_genre_distribution(spotify: SpotifyManager, location: list, 
    ...
    the Spotify API. Calculates distribution percentages for each genre found.
    
    Args:
        spotify (SpotifyManager): Instance of SpotifyManager for API access
    ...
    Example:
        ...
        >>> # For a 3-dimensional feature space
        >>> results = check_genre_distribution(spotify, [1,2,1], 50)
    ...
    song_genres, _, _ = spotify.get_genres_for_songs_batch(selected_songs)
...
if __name__ == '__main__':
    ...
    Process:
    1. Initializes database and Spotify API connection
    ...
    with get_db_connection() as conn:
        ...
        for i, location in enumerate(locations_to_process):
            ...
            results = check_genre_distribution(spotify, location, number_of_songs=50)
