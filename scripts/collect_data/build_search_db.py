"""
Spotify Genre Search Distribution Analysis Module

This module analyzes how Spotify's search results map to different genres by performing
...
def check_genre_distribution(spotify: SpotifyManager, genre: str, 
    ...
    Args:
        spotify (SpotifyManager): Instance of SpotifyManager for API interactions
    ...
    Example:
        ...
        >>> results = check_genre_distribution(spotify, "jazz", 5, 10)
    ...
    for search_num, query in enumerate(query_variations[:number_of_searches]):
        ...
        song_genres, tracks_data, artists_data = spotify.get_genres_for_songs_batch(selected_songs)
...
def build_search_db(genres: list[str], number_of_searches: int = 20, 
    ...
    with get_db_connection() as conn:
        ...
        for query_genre in genres:
            ...
            results = check_genre_distribution(spotify, query_genre, number_of_searches, number_of_songs)
